...
public class Biblioteca {
    ...
    public Prestamo realizarPrestamo(String isbn, int idU) throws Exception {
        ...
        if (!u.puedePedirPrestado())
            throw new UsuarioSinCupoException("Sin cupo para pedir más libros");
    ...
    // ⭐ Compatible con Java 8 (se reemplaza toList() por Collectors.toList())
    public List<Libro> topLibros() {
        return libros.values()
                .stream()
                .sorted((a, b) -> b.getVecesPrestado() - a.getVecesPrestado())
                .limit(5)
